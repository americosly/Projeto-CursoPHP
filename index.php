...
<head>
 ...
 <div class="row">
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?php echo "assets/img/$imagemCurso1" ?>" alt="<?php echo "Imagem de curso $nomeCurso1";?>">
      <div class="caption">
        <h3><?php echo $nomeCurso1; ?></h3>
        <p><? echo $descricaoCurso1; ?></p>
        <p><? echo $valorCurso1; ?></p>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?php echo "assets/img/$imagemCurso2" ?>" alt="<?php echo "Imagem de curso $nomeCurso2";?>">
      <div class="caption">
        <h3><?php echo $nomeCurso2; ?></h3>
        <p><? echo $descricaoCurso2; ?></p>
        <p><? echo $valorCurso2; ?></p>
        <a href="#" class="btn btn-primary" role="button">Comprar</a>
      </div>
    </div>
  </div>
